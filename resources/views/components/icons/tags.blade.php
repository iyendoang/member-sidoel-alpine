<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tags {{ $class ?? '' }}" width="{{ $width }}" height="{{ $height }}" style="{{ $style ?? '' }}" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
