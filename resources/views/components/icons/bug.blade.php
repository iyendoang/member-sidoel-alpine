<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bug {{ $class ?? '' }}" width="{{ $width ?? '24' }}" height="{{ $height ?? '24' }}" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
