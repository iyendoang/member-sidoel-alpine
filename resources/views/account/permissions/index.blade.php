...
@section('content')
   ...
   <div class="mb-8" x-data>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
         <div>
            <h2 class="text-xl sm:text-xl font-bold text-gray-900">Permissions Management</h2>
            <p class="text-gray-600 mt-1 italic">Manage your permissions</p>
         </div>
      </div>
         ...
         <div class="px-6 py-3 border-b border-gray-200">
            <div class="flex items-center justify-between">
               ...
               <div class="block relative">
                  <form action="{{ route('account.permissions.index') }}">
                  ...
                  <tr>
                     ...
                     <td class="px-6 py-4 flex text-center text-sm font-medium">
                        ...
                        @can('permissions.delete')
                           <button
                                   @click="$store.deleteModal.open('{{ route('account.permissions.destroy', $permission->id) }}')"
