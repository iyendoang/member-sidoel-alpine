...
@section('content')
   ...
   <div x-data class="mb-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
         <div>
            <h2 class="text-xl sm:text-xl font-bold text-gray-900">Create Package Category</h2>
            <p class="text-gray-600 mt-1 italic">Add a new category for your packages</p>
         </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden mt-5">
         <div class="px-6 py-6 border-b border-gray-200">
            ...
            <form method="POST" action="{{ route('account.category-packages.store') }}">
               @csrf
