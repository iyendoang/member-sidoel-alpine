...
@section('content')
   ...
   <div x-data class="mb-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
         <div>
            <h2 class="text-xl sm:text-xl font-bold text-gray-900">Create Outlet</h2>
            <p class="text-gray-600 mt-1 italic">Create a new outlet and its information</p>
         </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden mt-5">
         ...
         <div class="px-6 py-6 border-b border-gray-200">
            ...
            <form method="POST" action="{{ route('account.outlets.store') }}">
               @csrf

               <div class="space-y-4">
                  <div>
                     <label class="block text-sm font-medium text-gray-700">Code Outlet</label>
                     <input type="text" name="code_outlet" value="{{ old('code_outlet') }}" placeholder="Code Outlet"
                  ...
                  <div>
                     ...
                     <input type="text" name="phone" placeholder="No. Phone" value="{{ old('phone') }}"
